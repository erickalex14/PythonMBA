...
const NAV_ACCENTS: Record<string, string> = {
  movimientos: "37 99 235",
  liquidaciones: "124 58 237",
  ats: "245 158 11",
  "ventas-diarias": "22 163 74",
  ventas: "13 148 136",
  logs: "8 145 178",
  sync: "219 39 119",
  admin: "220 38 38",
      ...
      <aside className={`${styles.sidebar} ${mobileOpen ? styles.sidebarOpen : ""}`}>
        ...
        {permissions.includes("VIEW_MOVIMIENTOS") && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.movimientos }}
          >
        ...
        {permissions.includes("VIEW_LIQUIDACIONES") && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.liquidaciones }}
          >
        ...
        {permissions.includes("VIEW_ATS") && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.ats }}
          >
        ...
        {(permissions.includes("VIEW_VENTAS") || isUserAdmin) && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.ventas }}
          >
        ...
        {permissions.includes("VIEW_LOGS") && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.logs }}
          >
        ...
        {canViewSync && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.sync }}
          >
        ...
        {isUserAdmin && (
          <button
            ...
            style={{ ["--item-accent" as any]: NAV_ACCENTS.admin }}
          >
